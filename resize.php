...
if(! defined('DISPLAY_ERROR_MESSAGES') )	define ('DISPLAY_ERROR_MESSAGES', $_GET['debug'] == '1');				// Display error messages. Set to false to turn off errors (good for production websites)
